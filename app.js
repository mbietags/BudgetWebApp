...
var budgetController = (function() {
    ...
    // function constructor for expense as there will be a lot of expenses
...
var UIController = (function() {
    ...
    var nodeListForEach = function (list, callback) {
        // for loop that with each iteration will call our callback function
    ...
    return {
        ...
        clearFields: function() {
            ...
            // will trick slice method into thinking that we are giving it an array instead of a list so it will return an array
        ...
        formatNumber: function(number, type){
            ...
            */
            ...
            number = number.toFixed(2);   // method of number prototype
            ...
            if (int.length > 3) {
                int = int.substr(0, int.length - 3) + "," + int.substr(int.length - 3, int.length); // if 2310 -> 2,310 
            }
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var ctrlDeleteItem = function(event) {
        ...
        // not so clean but it should be so bad that I hardcoded this into the DOM structure
    ...
    return {
        init: function(){
            console.log("Application starterd");
...
controller.init(); // only function outside
